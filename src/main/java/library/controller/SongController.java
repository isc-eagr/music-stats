...
public class SongController {
    ...
    public String listSongs(
            ...
            @RequestParam(required = false) String artistMode,
            ...
            @RequestParam(required = false) String trlPeakMode,
            @RequestParam(required = false) Integer trlDays,
            @RequestParam(required = false) Integer trlDaysAtPeak,
            @RequestParam(required = false) String trlDaysAtPeakMode,
            ...
            @RequestParam(required = false) String vatosCuntdownPeakMode,
            @RequestParam(required = false) Integer vatosCuntdownDays,
            @RequestParam(required = false) Integer vatosCuntdownDaysAtPeak,
            @RequestParam(required = false) String vatosCuntdownDaysAtPeakMode,
            ...
            @RequestParam(required = false) String billboardPeakMode,
            @RequestParam(required = false) Integer billboardWeeks,
            @RequestParam(required = false) Integer billboardWeeksAtPeak,
            @RequestParam(required = false) String billboardWeeksAtPeakMode,
        ...
        List<SongCardDTO> songs = songService.getSongs(
                q, artistFilter, featuredArtist, album, genre, genreMode,
        ...
        model.addAttribute("artistMode", "excludes".equalsIgnoreCase(artistMode) ? "excludes" : "includes");
        ...
        model.addAttribute("trlDaysAtPeak", trlDaysAtPeak);
        ...
        model.addAttribute("vatosCuntdownDaysAtPeak", vatosCuntdownDaysAtPeak);
        ...
        model.addAttribute("billboardWeeksAtPeak", billboardWeeksAtPeak);
