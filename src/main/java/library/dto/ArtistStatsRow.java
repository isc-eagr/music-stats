...
public record ArtistStatsRow(
        ...
        int mainPlayCount,
        int groupPlayCount,
        int featuredPlayCount,
        int mainVatitoPlayCount,
        int groupVatitoPlayCount,
        int featuredVatitoPlayCount,
        int mainRobertloverPlayCount,
        int groupRobertloverPlayCount,
        int featuredRobertloverPlayCount,
        long timeListened,
    ...
    public static ArtistStatsRow from(ResultSet rs) throws SQLException {
        return new ArtistStatsRow(
                ...
                rs.getInt("main_play_count"),
                rs.getInt("group_play_count"),
                rs.getInt("featured_play_count"),
                rs.getInt("main_vatito_play_count"),
                rs.getInt("group_vatito_play_count"),
                rs.getInt("featured_vatito_play_count"),
                rs.getInt("main_robertlover_play_count"),
                rs.getInt("group_robertlover_play_count"),
                rs.getInt("featured_robertlover_play_count"),
